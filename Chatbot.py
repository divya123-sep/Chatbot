...
set_background(r"C:\Users\divya\OneDrive\Documents\Bert\1661423414767.jpg")
...
qa_pairs = {
    ...
    "What is data science?": "Data Science is the study of analyzing data to find useful information. It uses tools like math, statistics, and programming to understand patterns and make predictions. 📊",
    "What is your use?": "A BERT-based chatbot uses the BERT model to understand and respond to user queries by analyzing the context of the conversation. It can handle tasks like answering questions, providing information, or engaging in dialogue by comparing user inputs with predefined responses or generating replies. 🔍",
    ...
    "What is Microsoft Azure?": "Microsoft Azure is a cloud computing platform and service provided by Microsoft. It offers tools and resources for building, deploying, and managing applications and services through Microsoft's global data centers. ☁️",
}
